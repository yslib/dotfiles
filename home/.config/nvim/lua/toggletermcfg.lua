...
u.map_key('n', "<Leader>tf", ":ToggleTerm direction=float<CR>", { silent = true, desc = "Open a floating terminal" })
u.map_key('n', "<Leader>tv", ":ToggleTerm direction=vertical<CR>", { silent = true, desc = "Open a vertical terminal" })
