...
keymap('n', '<leader>fc', function() require('telescope.builtin').grep_string() end, { desc = 'Telescope Grep string' })
...
keymap('n', '<leader>fd', function() require('telescope.builtin').lsp_document_symbols() end,
